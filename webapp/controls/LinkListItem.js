sap.ui.define("nl.kadaster.test.flexcollayout.mycolleagues.controls.LinkListItem",[ 
    "sap/ui/core/Control"
], function(Control) {
    "use strict";
 
    var LinkListItem = Control.extend("nl.kadaster.test.flexcollayout.mycolleagues.controls.LinkListItem", {
        // the control API:
        metadata : {
            properties : {
	            "profileId" : "string",
